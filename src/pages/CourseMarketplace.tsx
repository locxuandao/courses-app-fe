...
import { BookOpen, Search, Filter, Loader2, Star, User, ShoppingCart } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-extrabold italic text-blue-400">Course Marketplace</h1>
          <p className="text-[oklch(60%_0.02_250)] mt-1">Discover premium knowledge from industry experts.</p>
        </div>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <p className="text-[oklch(60%_0.02_250)] font-medium">Curating courses for you...</p>
        </div>
        ...
        <div className="text-center py-24 bg-[oklch(20%_0.02_250)] rounded-3xl border border-[oklch(30%_0.02_250)]">
          ...
          <p className="text-[oklch(60%_0.02_250)]">Try adjusting your search or check back later.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredCourses.map((course) => (
            <div key={course.id} className="bg-[oklch(20%_0.02_250)] border border-[oklch(30%_0.02_250)] rounded-3xl overflow-hidden hover:border-blue-500/50 transition-all group shadow-2xl flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-[10px] font-bold tracking-widest uppercase bg-blue-500/10 text-blue-400 px-2 py-0.5 rounded border border-blue-500/20">PREMIUM</span>
                  <span className="text-[10px] font-bold tracking-widest uppercase bg-[oklch(30%_0.02_250)] text-[oklch(70%_0.02_250)] px-2 py-0.5 rounded">NEW</span>
                </div>
                ...
                <div className="mt-auto space-y-4">
                  <div className="flex items-center justify-between text-sm text-[oklch(70%_0.02_250)]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium truncate max-w-[120px]">{course.instructorName || 'Expert Instructor'}</span>
                    </div>
